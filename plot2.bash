...
plot '${ps}TDBH_hg_400_0_binarized.csv' using (\$6 + 0.0):(\$4 - 0.38) title '0 splits, tdbh with binarized wta' with points 2 \
   ...
   , '${ps}TDBH_hg_400_2_binarized.csv' using (\$6 + 0.2):(\$4 - 0.25) title '2 splits, tdbh with binarized wta' with points 5  \
...
plot '${ps}TDBHBin_hg_400_0_binarized.csv' using (\$6 + 0.0):(\$4 - 0.38) title '0 splits, tdbh-bin with binarized wta' with points 2 \
   , '${ps}TDBHBin_hg_400_0.csv'           using (\$6 + 0.1):(\$4 - 0.14) title '0 splits, tdbh-bin' with points 4  \
   , '${ps}TDBHBin_hg_400_2_binarized.csv' using (\$6 + 0.2):(\$4 - 0.25) title '2 splits, tdbh-bin with binarized wta' with points 5  \
...
plot '${ps}TDBH_hg_400_2_binarized.csv' using (\$6 + 0.0):(\$4 - 0.38) title 'tdbh with binarized wta' with points 2 \
   , '${ps}TDBH_hg_400_2.csv'           using (\$6 + 0.1):(\$4 - 0.14) title 'tdbh' with points 4  \
   , '${ps}TDBHBin_hg_400_2_binarized.csv' using (\$6 + 0.2):(\$4 - 0.25) title 'tdbh-bin with binarized wta' with points 5  \
   , '${ps}TDBHBin_hg_400_2.csv'           using (\$6 + 0.3):(\$4 - 0.25) title 'tdbh-bin' with points 6  \
   , '${ps}Complete_hg_400_2_binarized.csv' using (\$6 + 0.4):(\$4 - 0.67) title 'complete with binarized wta' with points 7  \
   , '${ps}Complete_hg_400_2.csv'           using (\$6 + 0.5):(\$4 - 0.27) title 'complete' with points 10

set output '${po}/400_3.gnuplot.tex'
plot '${ps}TDBH_hg_400_3_binarized.csv' using (\$6 + 0.0):(\$4 - 0.38) title 'tdbh with binarized wta' with points 2 \
   , '${ps}TDBH_hg_400_3.csv'           using (\$6 + 0.1):(\$4 - 0.14) title 'tdbh' with points 4  \
   , '${ps}TDBHBin_hg_400_3_binarized.csv' using (\$6 + 0.2):(\$4 - 0.25) title 'tdbh-bin with binarized wta' with points 5  \
   , '${ps}TDBHBin_hg_400_3.csv'           using (\$6 + 0.3):(\$4 - 0.25) title 'tdbh-bin' with points 6  \
   , '${ps}Complete_hg_400_3_binarized.csv' using (\$6 + 0.4):(\$4 - 0.67) title 'complete with binarized wta' with points 7  \
   , '${ps}Complete_hg_400_3.csv'           using (\$6 + 0.5):(\$4 - 0.27) title 'complete' with points 10
